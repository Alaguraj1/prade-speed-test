                        ...
                        <div className="col-lg-10 col-md-12 col-12">
                            <div className="row">
                                <div className="col-md-4 col-lg-2 col-6 mb-lg-0 mb-3">
                                    <Image src="/assets/img/home/wrap-with-love/1.jpg" alt="gift-wrap-1" style={{ width: "100%", borderRadius: "20px" }} />
                                ...
                                <div className="col-md-4 col-lg-2 col-6 mb-lg-0 mb-3">
                                    <Image src="/assets/img/home/wrap-with-love/2.jpg" alt="gift-wrap-2" style={{ width: "100%", borderRadius: "20px" }} />
                                ...
                                <div className="col-md-4 col-lg-2 col-6 mb-lg-0 mb-3">
                                    <Image src="/assets/img/home/wrap-with-love/3.jpg" alt="gift-wrap-3" style={{ width: "100%", borderRadius: "20px" }} />
                                    <h6 className="gift-wrap-name" style={{ cursor: "pointer" }}
                                        onClick={() => {
                                            router.push({
                                                pathname: "/shop",
                                ...
                                <div className="col-md-4 col-lg-2 col-6 mb-lg-0 mb-3">
                                    <Image src="/assets/img/home/wrap-with-love/4.jpg" alt="gift-wrap-4" style={{ width: "100%", borderRadius: "20px" }} />
                                    <h6 className="gift-wrap-name" style={{ cursor: "pointer" }}
                                        onClick={() => {
                                            router.push({
                                                pathname: "/shop",
                                ...
                                <div className="col-md-4 col-lg-2 col-6 mb-lg-0 mb-3">
                                    <Image src="/assets/img/home/wrap-with-love/5.jpg" alt="gift-wrap-5" style={{ width: "100%", borderRadius: "20px" }} />
                                    <h6 className="gift-wrap-name" style={{ cursor: "pointer" }} onClick={() => {
                                        router.push({
                                            pathname: "/shop",
                                ...
                                <div className="col-md-4 col-lg-2 col-6 mb-lg-0 mb-3">
                                    <Image src="/assets/img/home/wrap-with-love/6.jpg" alt="gift-wrap-6" style={{ width: "100%", borderRadius: "20px" }} />
                                    <h6 className="gift-wrap-name" style={{ cursor: "pointer" }}
                                        onClick={() => {
                                            router.push({
                                                pathname: "/shop",
